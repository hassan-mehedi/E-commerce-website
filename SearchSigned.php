  ...
  <div class='container-fluid'>
    <div class='row'>
      ...
      if (isset($_POST['searchButton'])) {
        ...
        $db = mysqli_connect("localhost", "root", "", "ecommerce");
        $sql = "SELECT * FROM  admin WHERE product_name = '" . $searchKey . "' OR product_type = '" . $searchKey . "'";
        $result = mysqli_query($db, $sql);
        $found = mysqli_num_rows($result);
        if ($found == 0) {
          echo "<h2 style='margin-left:20px;'>No product found</h2>";
        } else {
          echo "<h3 style='margin-left:20px;'> $found search result found for $searchKey </h3>";
